...
DEFAULT_BASE_AMPLIFICATION = 1.5  # Renamed from DEFAULT_AMPLIFICATION
...
CLASSES_TO_DISCARD_CONST = ["anus"]  # "navel" can be tracked_box_2, "breast" and "foot" are tracked.
